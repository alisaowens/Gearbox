...
class MiscellaneousTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        fetchRequest.predicate = NSPredicate(format: "majorCategory == %@", "Miscellaneous")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //Fetches the appropriate miscellaneous for the data source layout
        ...
        cell.miscellaneousDetailsLabel.text = details
        if selfWeight != "" && selfWeight != nil {
            cell.miscellaneousWeightLabel.text = selfWeight! + " g"
            cell.miscellaneousWeightLabel.textColor = UIColor.black
        }
        else if manufWeight != "" && manufWeight != nil {
            cell.miscellaneousWeightLabel.text = manufWeight! + " g"
            cell.miscellaneousWeightLabel.textColor = UIColor(red: 0.498, green: 0, blue: 0, alpha: 1)
        }
        else {
            cell.miscellaneousWeightLabel.text = "g"
            cell.miscellaneousWeightLabel.textColor = UIColor.black
        }
        return cell
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "AddMiscellaneous":
            guard let miscellaneousViewController = segue.destination as? MiscellaneousViewController else{
                fatalError("Unexpected destination: \(segue.destination)")
            }
            miscellaneousViewController.isEdit = false
        case "ShowDetail":
            guard let detailViewController = segue.destination as? MiscellaneousViewController else{
                fatalError("Unexpected destination: \(segue.destination)")
            }
