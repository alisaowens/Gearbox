...
class MiscellaneousViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextViewDelegate, UIScrollViewDelegate {
    //MARK: Properties
    ...
    override func viewDidLoad() {
        ...
        if let gear = gear {
            ...
            miscellaneousDetails.text = gear.value(forKeyPath: "details") as? String
            ...
            miscellaneousNotes.text = gear.value(forKeyPath: "notes") as? String
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?){
        ...
        let detailsValue = miscellaneousDetails.text
        let majorCategory = "Miscellaneous"
        let selfWeightValue = selfWeight.text
        let manufWeightValue = manufWeight.text
        let notesValue = miscellaneousNotes.text
        if isEdit == false {
    ...
    func addDoneButtonOnKeyboard() {
        ...
        self.miscellaneousNotes.inputAccessoryView = notesToolbar
        
        self.selfWeight.inputAccessoryView = doneToolbar
        self.manufWeight.inputAccessoryView = doneToolbar
        self.miscellaneousDetails.inputAccessoryView = doneToolbar
    }
    ...
    fileprivate func registerKeyboardNotifications() {
        NotificationCenter.default.addObserver(self, selector: #selector(MiscellaneousViewController.keyboardWillShow), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(MiscellaneousViewController.keyboardWillHide), name: NSNotification.Name.UIKeyboardWillHide, object: nil)
    }
